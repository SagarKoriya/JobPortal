...
const Jobs = () => {
    ...
    const handleClickgotoJobsElectrition = () => navigate('/JobsElectrition')
    const handleClickgotoJobsCarpenter = () => navigate('/JobsCarpenter')
    const handleClickgotoJobsPlumber = () => navigate('/JobsPlumber')
    const handleClickgotoJobsPainter = () => navigate('/JobsPainter')
            ...
            <div className='jobContainer rounded-[10px] bg-slate-50 block flex-wrap items-center mb-5 p-10'>
                <div>
                    <div>
                        ...
                        <span className='flex float-right cursor-pointer mt-4 text-blueColor hover:font-semibold' onClick={handleClickgotoJobsElectrition}>Show More
                ...
                <div className='mt-10'>
                    <div>
                        ...
                        <span className='flex float-right cursor-pointer mt-4 text-blueColor hover:font-semibold' onClick={handleClickgotoJobsCarpenter}>Show More
                            <div className='mt-1 ml-2'><AiOutlineArrowRight /></div></span>
                        <div className='flex ' style={{ flex: 1, height: '1px', backgroundColor: 'black' }} />
                    </div><br />
                    <div className='group group/item singleJob rounded-[10px] w-[30%] p-[20px] bg-white hover:bg-blueColor shadow-lg shadow-greyIsh-400/700 hover:shadow-lg'>
                ...
                <div className='mt-10'>
                    <div>
                        ...
                        <span className='flex float-right cursor-pointer mt-4 text-blueColor hover:font-semibold' onClick={handleClickgotoJobsPlumber}>Show More
                            <div className='mt-1 ml-2'><AiOutlineArrowRight /></div></span>
                        <div className='flex ' style={{ flex: 1, height: '1px', backgroundColor: 'black' }} />
                    </div><br />
                    <div className='group group/item singleJob rounded-[10px] w-[30%] p-[20px] bg-white hover:bg-blueColor shadow-lg shadow-greyIsh-400/700 hover:shadow-lg'>
                ...
                <div className='mt-10'>
                    <div>
                        ...
                        <span className='flex float-right cursor-pointer mt-4 text-blueColor hover:font-semibold' onClick={handleClickgotoJobsPainter}>Show More
                            <div className='mt-1 ml-2'><AiOutlineArrowRight /></div></span>
                        <div className='flex ' style={{ flex: 1, height: '1px', backgroundColor: 'black' }} />
                    </div><br />
                    <div className='group group/item singleJob rounded-[10px] w-[30%] p-[20px] bg-white hover:bg-blueColor shadow-lg shadow-greyIsh-400/700 hover:shadow-lg'>
